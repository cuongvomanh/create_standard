...
@RestController
@RequestMapping("/api/standarddemoaplication-kafka")
public class StandarddemoaplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(StandarddemoaplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public StandarddemoaplicationKafkaResource(KafkaProperties kafkaProperties) {
