package com.mycompany.standarddemoapplication.web.rest;

import com.mycompany.standarddemoapplication.config.KafkaProperties;
...
class StandarddemoaplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        StandarddemoaplicationKafkaResource kafkaResource = new StandarddemoaplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/standarddemoaplication-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/standarddemoaplication-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
