...
@RestController
@RequestMapping("/api/standarduaa-kafka")
public class StandarduaaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(StandarduaaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public StandarduaaKafkaResource(KafkaProperties kafkaProperties) {
