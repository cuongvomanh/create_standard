...
@RestController
@RequestMapping("/api/standardgateway-kafka")
public class StandardgatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(StandardgatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public StandardgatewayKafkaResource(KafkaProperties kafkaProperties) {
